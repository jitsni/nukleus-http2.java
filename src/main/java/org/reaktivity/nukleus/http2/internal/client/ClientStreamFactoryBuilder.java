...
public final class ClientStreamFactoryBuilder implements StreamFactoryBuilder
{
    ...
    private final Long2ObjectHashMap<Http2ClientConnection> correlations;
    ...
    @Override
    public StreamFactoryBuilder setGroupBudgetClaimer(LongFunction<IntUnaryOperator> claimGroupBudget)
    {
        return this;
    }

    @Override
    public StreamFactoryBuilder setGroupBudgetReleaser(LongFunction<IntUnaryOperator> releaseGroupBudget)
    {
        return this;
    }
    ...
    public StreamFactory build()
    {
        ...
        return new ClientStreamFactory(config, router, writeBuffer, bufferPool, supplyInitialId,
                supplyReplyId, correlations);
    }
}
