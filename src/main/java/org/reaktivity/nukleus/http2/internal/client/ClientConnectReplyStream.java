...
class ClientConnectReplyStream
{
        ...
        int length)
    {
        if (msgTypeId == BeginFW.TYPE_ID)
        {
            ...
            final long correlationId = begin.streamId();
            http2ClientConnection = factory.correlations.remove(correlationId);
        }
        else
        {
...
//                doPriority();
    ...
    private void handleHttp2Headers()
    {
        ...
        long acceptReplyStreamId = http2ClientConnection.acceptReplyStreamId;
        ...
        factory.router.setThrottle(http2ClientConnection.acceptReplyStreamId, this::handleAcceptReplyThrottle);
