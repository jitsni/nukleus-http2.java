...
class Http2ClientConnectionManager
{
    ...
    public Http2ClientStreamId newStream(BeginFW httpBegin, MessageConsumer acceptThrottle)
    {
        ...
        long acceptReplyStreamId = factory.supplyReplyId.applyAsLong(httpBegin.streamId());
        Http2ClientConnection connection = new Http2ClientConnection(factory, httpBegin.routeId(), acceptReplyStreamId);
